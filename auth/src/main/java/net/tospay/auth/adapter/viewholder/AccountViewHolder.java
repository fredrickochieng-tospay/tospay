...
public class AccountViewHolder extends RecyclerView.ViewHolder {
    ...
    public AccountViewHolder(ListItemAccountViewBinding binding, OnAccountItemClickListener onAccountTypeSelectedListener) {
        super(binding.getRoot());
        this.binding = binding;

        binding.getRoot().setOnClickListener(view -> {
            if (!binding.getAccount().isChecked()) {
                binding.getAccount().setChecked(true);
            }
