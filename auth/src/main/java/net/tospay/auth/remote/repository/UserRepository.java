...
public class UserRepository {
    ...
    public LiveData<Resource<Result>> updateAddress(String bearerToken, SharedPrefManager sharedPrefManager,
    ...
    public LiveData<Resource<Result>> saveFcmToken(String bearerToken, String fcmToken) {
        ...
        return new NetworkBoundResource<Result, Result>(mAppExecutors) {
            ...
            @Override
            protected LiveData<ApiResponse<Result>> createCall() {
                return mUserService.saveFcmToken(bearerToken, request);
            }
        }.asLiveData();
    }
