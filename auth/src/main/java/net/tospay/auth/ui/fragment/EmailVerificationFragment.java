...
public class EmailVerificationFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_email_verification, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.btnVerify.setOnClickListener(this::onVerifyClicked);
        mBinding.btnResend.setOnClickListener(this::resend);
    }

    private void verifyEmailToken(String code) {
        warning_layout.setVisibility(View.INVISIBLE);
        loader.setVisibility(View.VISIBLE);

        auth.verifyEmail(tospayUser.getEmail(), code, new VerificationListener() {
            @Override
    ...
    private void resend(View view) {
        ...
        auth.resendEmailVerificationCode(tospayUser.getEmail(), new VerificationListener() {
            @Override
            public void onSuccess() {
                touchable(mActivity);
                loader.setVisibility(View.GONE);
